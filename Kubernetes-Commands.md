...
<pre class=" language-sh"><code class="prism  language-sh">--Ex:----------------------------------------controlplane $ kubectl create -f vignesh-namespace.yaml
...
--Ex:------------------------------------------controlplane $ kubectl delete namespace vignesh-ns
...
kube-system          canal-          2/2     Running   2 (8m2s ago)   33d
...
kube-system          calico-kube-controllers-9d57d8f49-jvt8w   1/1     Running   3 (8m14s ago)   33d   192.168.0.2   controlplane   lt;none&gt;<none>           <none>
kube-system          canal-          2/2     Running   2 (8m13s ago)   33d   172.30.2.2    node01         <none>           <none>
kube-system          canal-j6pwg                    
...
kube-system          coredns-86b698fbb6-hqpmj                  1/1     Running   1 (8m13s ago)   33d   192.168.1.2   node01         lt;none&gt;        <none>
kube-system          etcd-controlplane                         1/1     Running   2 (8m14s ago)   33d   172.30.1.2    controlplane   &<none>           &
kube-system          kube-apiserver-controlplane               1/1     Running   2 (8m14s ago)   33d   172.30.1.2    controlplane   &           <none>           
...
kube-system          kube-proxy-lhxdd                          1/1     Running   1 (8m13s ago)   33d   172.30.2.2    node01         &lt;none&gt;<none>           &lt;none&gt;<none>
...
--Ex:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
controlplane $ kubectl createvignesh-pod-1 created created-1 created
```
```yaml
---
apiVersion: v1
...
vignesh-ns           vignesh-pod-2                             1/1     Running   0             7s     192.168.1.5   node01                    &lt;none&gt;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjQyNDM4MzhdfQ==
-->